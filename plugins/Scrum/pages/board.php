...
$query = "SELECT DISTINCT v.date_order, v.version, b.target_version
	...
	WHERE v.project_id IN (".join(", ", $project_ids). ") and v.obsolete =0 
...
<p class="summary"><a href="/mantis/view.php?id=<?php echo $bug->id ?>"> <?php echo $bug->id ?>: </a> <?php echo bug_format_summary( $bug->id, SUMMARY_FIELD ); ?></p>
